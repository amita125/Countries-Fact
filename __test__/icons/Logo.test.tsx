...
describe("Logo Component", () => {
  it("renders the Logo component with the correct SVG attributes", () => {
    ...
    expect(logoSVG).toHaveAttribute("xmlns", "http://www.w3.org/2000/svg");
    expect(logoSVG).toHaveAttribute("viewBox", "0 0 24 24");
    expect(logoSVG).toHaveAttribute("stroke", "currentColor");
    expect(logoSVG).toHaveClass("w-6 h-6");
  });
  ...
  it("renders the correct SVG path", () => {
    ...
    expect(logoSVG).toBeInTheDocument();
    expect(logoSVG.querySelector("path")).toHaveAttribute(
      "d",
